...
def lst_sq_fit3(X, Y, params=False):
    ...
    [a, b, c, d] = plsq[0]
    func_text = '%.16f + %.16f * x + %.16f * x**2 + %.16f * x**3' % (
        a, b, c, d)
...
def lst_sq_fit4(X, Y, params=False):
    ...
    [a, b, c, d, e] = plsq[0]
    func_text = '%.16f + %.16f * x + %.16f * x**2 + %.16f * x**3 + %.16f * x**4' % (
        a, b, c, d, e)
    if params:
        return func_text, plsq[0]
    else:
...
def lst_sq_fit5(X, Y, params=False):
    ...
    [a, b, c, d, e, f] = plsq[0]
    func_text = '%.16f + %.16f * x + %.16f * x**2 + %.16f * x**3 + %.16f * x**4 + %.16f * x**5' % (
        a, b, c, d, e, f)
    if params:
        return func_text, plsq[0]
    else:
...
def lst_sq_fit6(X, Y, params=False):
    ...
    func_text = '%.16f + %.16f * x + %.16f * x**2 + %.16f * x**3 + %.16f * x**4 + %.16f * x**5 + %.16f * x**6' % (
        a, b, c, d, e, f, g)
    if params:
        return func_text, plsq[0]
    else:
...
def residuals7(p, y, x):
    a, b, c, d, e, f, g, h = p
    err = y - (a + b * x + c * x**2 + d * x**3 + e *
               x**4 + f * x**5 + g * x**6 + h * x**7)
    return err
...
def lst_sq_fit7(X, Y, params=False):
    ...
    func_text = '%.16f + %.16f * x + %.16f * x**2 + %.16f * x**3 + %.16f * x**4 + %.16f * x**5 + %.16f * x**6 + %.16f * x**7' % (
        a, b, c, d, e, f, g, h)
    if params:
        return func_text, plsq[0]
    else:
...
def residuals8(p, y, x):
    a, b, c, d, e, f, g, h, i = p
    err = y - (a + b * x + c * x**2 + d * x**3 + e * x **
               4 + f * x**5 + g * x**6 + h * x**7 + i * x**8)
    return err
...
def lst_sq_fit8(X, Y, params=False):
    ...
    func_text = '%.16f + %.16f * x + %.16f * x**2 + %.16f * x**3 + %.16f * x**4 + %.16f * x**5 + %.16f * x**6 + %.16f * x**7 + %.16f * x**8' % (
        a, b, c, d, e, f, g, h, i)
    if params:
        return func_text, plsq[0]
    else:
...
def residuals9(p, y, x):
    ...
    err = y - (a + b * x + c * x**2 + d * x**3 + e * x**4 + f *
               x**5 + g * x**6 + h * x**7 + i * x**8 + j * x**9)
    return err
...
def lst_sq_fit9(X, Y, params=False):
    ...
    func_text = '%.16f + %.16f * x + %.16f * x**2 + %.16f * x**3 + %.16f * x**4 + %.16f * x**5 + %.16f * x**6 + %.16f * x**7 + %.16f * x**8 + %.16f * x**9' % (
        a, b, c, d, e, f, g, h, i, j)
    if params:
        return func_text, plsq[0]
    else:
