...
def ll(t):
    ...
    return (lat_k * (lat_deg + lat_mn / 60 + lat_sec / 3600),
            long_k * (long_deg + long_mn / 60 + long_sec / 3600))
...
def lll():
    ...
    if EW == 'E':
        ...
        long_k = 1
    # print(lat_deg, lat_mn, lat_sec, lat_k, long_deg, long_mn, long_sec,
    # long_k)
    return (lat_k * (lat_deg + lat_mn / 60 + lat_sec / 3600),
            long_k * (long_deg + long_mn / 60 + long_sec / 3600))
